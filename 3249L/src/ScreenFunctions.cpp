  ...
  int InitialTime = 0;
    ...
    //pros::screen::print(pros::TEXT_MEDIUM, 3, "Seconds Passed: %3d", i++);
      while (pros::competition::is_autonomous()) {
        ...
        pros::screen::print(pros::TEXT_SMALL,6,"FPS:%3d",1000/((1000/FrameRate)-TimePast));
          ...
          pros::screen::print(pros::TEXT_SMALL,6,"Time Between Clocks:%3d",TimePast);
          pros::screen::print(pros::TEXT_SMALL,7,"FPS:%3d",1000/((1000/FrameRate)-TimePast));
          ...
          pros::screen::print(pros::TEXT_SMALL,7,"FPS:%3d",1000/((1000/FrameRate)-TimePast));
          pros::screen::print(pros::TEXT_SMALL,8,"Time Between Clocks:%3d",TimePast);
        ...
        if/bbbnm,
          if(bot.failed){
          pros::screen::print(pros::TEXT_SMALL,9,"Did PurePursuit fail?");
        ...
        if (bot.PurePursuit){
          pros::screen::print(pros::TEXT_SMALL,11,"Is PurePursuit on?");
          pros::screen::set_pen(0xff0000);
